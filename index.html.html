...
<head>
    ...
    <title>Sistema de Gestão J16 - Cloud Edition</title>
    ...
    <style>
        ...
        * {
        ...
        /* Para telas grandes, força 4 colunas */
        ...
        /* Para telas muito grandes, força 6 colunas */
...
<body>
    <header>
        <div class="header-content">
            ...
            <nav>
                ...
                <button class="nav-btn" onclick="showSection('analise')">Análise</button>
            </nav>
    ...
    <div class="container">
        ...
        <section id="dashboard" class="section active">
            ...
            <div class="analysis-grid">
                <div class="analysis-card">
                    <div class="chart-title">📊 Performance Operacional</div>
                    <div class="metric">
                ...
                <div class="analysis-card">
                    <div class="chart-title">💰 Análise Financeira</div>
                    <div class="metric">
                    ...
                    <div class="metric">
                        <span class="metric-label">ROI Real (c/ inflação)</span>
                        <span class="metric-value" id="roiReal">0%</span>
                    </div>
                </div>

                <div class="analysis-card">
                    <div class="chart-title">📈 Recebimentos</div>
                    <div class="metric">
                ...
                <div class="analysis-card">
                    <div class="chart-title">📉 Impacto da Inflação</div>
                    <div class="metric">
                        <span class="metric-label">Inflação Acumulada</span>
                        <span class="metric-value" id="inflacaoAcumulada">0%</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Perda Poder de Compra</span>
                        <span class="metric-value" id="perdaInflacao">R$ 0</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Custo Corrigido</span>
                        <span class="metric-value" id="custoCorrigido">R$ 0</span>
                    </div>
                    <div class="metric">
            ...
            <button class="btn btn-export" onclick="exportarDados()">📥 Exportar Dados JSON</button>
            <button class="btn btn-export" onclick="importarDados()" style="margin-left: 10px; background: var(--accent);">📤 Importar Dados JSON</button>
            <input type="file" id="fileImport" accept=".json" style="display: none;" onchange="processarImportacao(event)">
            <button class="btn btn-secondary" onclick="limparDados()" style="float: right; margin-right: 10px; background: var(--danger);">🗑️ Limpar Todos os Dados</button>
            
            <!-- Botões Cloud -->
            <button class="btn btn-cloud" onclick="fazerBackupCloud()" style="background: linear-gradient(135deg, var(--success), var(--secondary)); margin-left: 10px;">☁️ Backup para Cloud</button>
            <button class="btn btn-cloud" onclick="restaurarDaCloud()" style="background: linear-gradient(135deg, var(--accent), var(--primary)); margin-left: 10px;">📥 Restaurar da Cloud</button>
            <button class="btn btn-cloud" onclick="verificarStatusCloud()" style="background: rgba(255,255,255,0.1); margin-left: 10px;">📊 Status Cloud</button>
        </section>

        <!-- COMPRAS SECTION -->
        <section id="compras" class="section">
            <h2 class="section-title">📦 Cadastro de Compras</h2>
        ...
        <section id="vendas" class="section">
            <h2 class="section-title">💵 Cadastro de Vendas</h2>
        ...
        <section id="parcelas" class="section">
            <h2 class="section-title">📋 Controle de Parcelas</h2>
            ...
            <div class="analysis-grid" style="margin-bottom: 30px;">
                ...
                <div class="analysis-card">
                    <div class="chart-title">💵 Fluxo Mensal</div>
                    <div class="metric">
                        <span class="metric-label">Próximo Vencimento</span>
                        <span class="metric-value" id="proximoVencimento">-</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Valor do Próximo Mês</span>
                        <span class="metric-value" id="valorProximoMes">R$ 0</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Lucro do Próximo Mês</span>
                        <span class="metric-value" id="lucroProximoMes">R$ 0</span>
                    </div>
                </div>

                <div class="analysis-card">
                    <div class="chart-title">📊 Análise de Lucro</div>
                    <div class="metric">
                        <span class="metric-label">Lucro Total a Receber</span>
                        <span class="metric-value" id="lucroTotalReceber">R$ 0</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Margem Média Parcelas</span>
                        <span class="metric-value" id="margemMediaParcelas">0%</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Lucro Já Recebido</span>
                        <span class="metric-value" id="lucroRecebido">R$ 0</span>
                    </div>
                </div>
            </div>

            <!-- Calendário de Vencimentos Mensais -->
            <div class="chart-container">
                <div class="chart-title">📅 Calendário de Recebimentos Mensais</div>
        ...
        <section id="inflacao" class="section">
            <h2 class="section-title">📊 Análise de Inflação (IPCA)</h2>
            
            <p style="color: var(--gray); margin-bottom: 20px;">
                Insira os índices mensais do IPCA para calcular o impacto da inflação no seu negócio.
            ...
            <div class="analysis-grid" style="margin-top: 30px;">
                <div class="analysis-card">
                    ...
                    <div class="metric">
                        <span class="metric-label">Inflação Acumulada 2024</span>
                    ...
                    <div class="metric">
                        <span class="metric-label">Custo Corrigido (Inflação)</span>
        ...
        <section id="analise" class="section">
            ...
            <div class="analysis-grid">
                <div class="analysis-card">
                    ...
                    <div class="metric">
                        <span class="metric-label">ROI Nominal</span>
                        <span class="metric-value" id="analiseROI">0%</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">ROI Real (Descontada Inflação)</span>
                        <span class="metric-value" id="analiseROIReal">0%</span>
                    </div>
                    <div class="metric">
                    ...
                    <div class="metric">
                        <span class="metric-label">Markup Médio</span>
                        <span class="metric-value" id="analiseMarkup">0%</span>
                    </div>
                </div>

                <div class="analysis-card">
                    <div class="chart-title">📦 Gestão de Estoque</div>
                    <div class="metric">
                    ...
                    <div class="metric">
                        <span class="metric-label">Estoque Restante</span>
                        <span class="metric-value" id="analiseEstoqueAtual">0 un</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Capital Imobilizado</span>
                        <span class="metric-value" id="analiseCapitalEstoque">R$ 0</span>
                    </div>
                </div>

                <div class="analysis-card">
                    <div class="chart-title">📮 Rastreamento Correios</div>
                    <div class="form-group" style="margin-bottom: 15px;">
                        <label style="font-size: 11px; color: var(--gray); margin-bottom: 5px; display: block;">Código de Rastreio</label>
                    ...
                    <div id="resultadoRastreio" style="margin-top: 15px; font-size: 11px; max-height: 300px; overflow-y: auto;">
                        <div style="text-align: center; padding: 20px; color: var(--gray);">
                            Digite um código de rastreio dos Correios
                        </div>
                    </div>
                </div>
                ...
                <div class="analysis-card">
                    ...
                    <div class="metric">
                        <span class="metric-label">Entrada Total</span>
                        <span class="metric-value" id="analiseEntrada">R$ 0</span>
                    </div>
                    <div class="metric">
                        <span class="metric-label">Saída Total</span>
                    ...
                    <div class="metric">
                        <span class="metric-label">Eficiência de Recebimento</span>
    ...
    <script>
        ...
        async function rastrearEncomenda() {
            ...
            if (!codigo) {
                resultado.innerHTML = '<div style="color: var(--danger); padding: 10px;">❌ Digite um código de rastreio!</div>';
                return;
            }
            ...
            if (!regex.test(codigo)) {
                resultado.innerHTML = '<div style="color: var(--danger); padding: 10px;">❌ Código inválido! Formato: AA123456789BR</div>';
                return;
            }
            
            resultado.innerHTML = '<div style="text-align: center; padding: 20px; color: var(--accent);">🔄 Rastreando encomenda...</div>';
            
            try {
                // API 1: Tentar API pública brasileira
                ...
                if (data.quantidade !== undefined) {
                    if (data.quantidade === 0 || !data.eventos || data.eventos.length === 0) {
                        resultado.innerHTML = `
                            <div style="color: var(--danger); padding: 10px;">
                                ...
                                <span style="font-size: 10px;">O código pode estar incorreto ou ainda não foi postado.</span>
                            </div>
                        `;
                        return;
                    }
                    ...
                    let html = `
                        <div style="background: rgba(6, 214, 160, 0.1); padding: 10px; border-radius: 5px; margin-bottom: 10px; border-left: 3px solid var(--success);">
                            <div style="font-weight: 700; color: var(--success); margin-bottom: 5px;">📦 ${codigo}</div>
                            <div style="color: var(--light); font-size: 10px;">Status: ${data.eventos[0].status}</div>
                        </div>
                        <div style="font-weight: 700; margin-bottom: 10px; color: var(--accent); font-size: 11px;">📍 Histórico de Movimentação:</div>
                    `;
                    ...
                    data.eventos.forEach((evento, index) => {
                        ...
                        html += `
                            <div style="background: ${bgColor}; border-left: 3px solid ${borderColor}; padding: 8px; margin-bottom: 6px; border-radius: 3px;">
                                ...
                                ${evento.local ? `<div style="color: var(--gray); font-size: 10px;">📍 ${evento.local}</div>` : ''}
                                ${evento.origem ? `<div style="color: var(--gray); font-size: 9px;">🔹 De: ${evento.origem}</div>` : ''}
                                ${evento.destino ? `<div style="color: var(--gray); font-size: 9px;">🔹 Para: ${evento.destino}</div>` : ''}
                ...
                // Solução alternativa: abrir site dos Correios
                resultado.innerHTML = `
                    <div style="padding: 10px;">
                        <div style="color: var(--danger); margin-bottom: 15px;">
                            ❌ Não foi possível consultar via API.<br>
                            <span style="font-size: 10px;">As APIs podem estar temporariamente indisponíveis.</span>
                        </div>
                        <div style="background: rgba(247, 184, 1, 0.1); padding: 15px; border-radius: 5px; border: 1px solid var(--accent);">
                            ...
                            <div style="margin-top: 10px; font-size: 9px; color: var(--gray);">
                                Cole o código <strong>${codigo}</strong> no site oficial
                            </div>
                        </div>
                    </div>
                `;
        ...
        async function carregarDadosDaCloud() {
            if (!supabaseClient || !usuarioCloud) {
                console.log('⚠️ Não conectado à cloud');
                return false;
            }
            
            try {
                console.log('📥 Baixando dados da cloud...');
                ...
                console.log('✅ Dados carregados da cloud:', {
        ...
        async function salvarCompraNaCloud(compra) {
            ...
            try {
                ...
                console.log('☁️ Compra salva na cloud:', compra.id);
            } catch (error) {
                console.error('❌ Erro ao salvar compra na cloud:', error);
            }
        }
        ...
        async function salvarVendaNaCloud(venda) {
            ...
            try {
                ...
                if (error) throw error;
                console.log('☁️ Venda salva na cloud:', venda.id);
            } catch (error) {
                console.error('❌ Erro ao salvar venda na cloud:', error);
            }
        }
        ...
        async function salvarParcelaNaCloud(parcela) {
            ...
            try {
                ...
                if (error) throw error;
                console.log('☁️ Parcela salva na cloud:', parcela.id);
            } catch (error) {
                console.error('❌ Erro ao salvar parcela na cloud:', error);
            }
        }
        ...
        async function deletarDaCloud(tabela, id) {
            ...
            try {
                ...
                if (error) throw error;
                console.log(`☁️ ${tabela} deletado da cloud:`, id);
            } catch (error) {
                console.error(`❌ Erro ao deletar ${tabela} da cloud:`, error);
            }
        }
        ...
        // ==========================================
        // FUNÇÕES BÁSICAS (definidas primeiro)
        // ==========================================
        ...
        function showSection(sectionId) {
            ...
            // Atualizar dados ao mudar de seção
        ...
        // ==========================================
        // CONFIGURAÇÃO SUPABASE (Cloud Backup)
        // ==========================================
        ...
        function inicializarSupabase() {
            try {
                if (typeof window.supabase !== 'undefined') {
                    ...
                    console.log('☁️ Supabase Cloud Backup ativado!');
                    
                    // Verificar se está logado no cloud
                    supabaseClient.auth.getSession().then(({ data: { session } }) => {
                        if (session) {
                            usuarioCloud = session.user;
                            console.log('✅ Conectado à cloud como:', usuarioCloud.email);
                            
                            // Atualizar badge de status
                            atualizarStatusCloud('online', usuarioCloud.email);
                            
                            if (typeof mostrarNotificacao === 'function') {
                                mostrarNotificacao('✅ Sincronização automática ativada!');
                            }
                        } else {
                            console.log('ℹ️ Cloud disponível - faça login para sincronização automática');
                    ...
                    console.warn('⚠️ SDK Supabase não carregado - sincronização cloud desabilitada');
                    atualizarStatusCloud('offline');
                }
            } catch (error) {
        ...
        async function inicializarDados() {
            ...
            if (supabaseClient && usuarioCloud) {
                console.log('☁️ Usuário logado, carregando dados da cloud...');
            ...
            // Não sobrescrever dados existentes do usuário
            if (compras.length === 0 && vendas.length === 0 && parcelas.length === 0) {
                console.log('Sistema vazio. Adicionando dados de exemplo básicos...');
                compras = [
                    {
                        id: 1738800000000,
                        data: '2024-01-15',
                ...
                console.log('✅ Dados do usuário detectados e carregados:');
                ...
                if (compras.length > 0) {
                    ...
                    console.log(`  📦 Total de rastreadores comprados: ${totalUnidades}`);
                ...
                if (vendas.length > 0) {
                    ...
                    console.log(`  📊 Total de rastreadores vendidos: ${totalVendido}`);
                ...
                if (parcelas.length > 0) {
                    ...
                    console.log(`  ⏸️ Parcelas pendentes: ${parcelasPendentes}`);
                }
            }
        ...
        // Navegação (função já definida no início do script)
            ...
            try {
                ...
                if (compraEditandoId) {
                    ...
                    if (index !== -1) {
                        ...
                        // 🔥 SALVAR NA CLOUD AUTOMATICAMENTE
            ...
            compras.forEach(c => {
                tbody.innerHTML += `
                    <tr>
                        ...
                        <td>${c.fornecedor || '-'}</td>
                        <td>
                            <button class="btn-delete" onclick="editarCompra(${c.id})" style="background: var(--accent); margin-right: 5px;">✏️ Editar</button>
                            <button class="btn-delete" onclick="deletarCompra(${c.id})">🗑️ Excluir</button>
                        </td>
                    </tr>
                `;
            });
        ...
        function deletarCompra(id) {
            if (confirm('Deseja realmente excluir esta compra?')) {
                ...
                // 🔥 DELETAR DA CLOUD AUTOMATICAMENTE
        ...
        function editarCompra(id) {
            try {
                ...
                alert('Erro ao carregar compra para edição.');
            }
        }
        ...
        function adicionarVenda() {
            ...
            alert('✓ Venda salva com sucesso! As parcelas foram atualizadas com base na data de venda.');
        }
        ...
        function gerarParcelas(venda) {
            ...
            // Calcular diferença de centavos
            ...
            console.log('📅 Gerando parcelas baseadas na data de VENDA:', {
                dataVenda: venda.data,
                dataVendaObj: dataVenda.toLocaleDateString('pt-BR'),
                numParcelas: venda.numParcelas
            });
            
            // Buscar custo unitário médio das compras
            ...
            for (let i = 0; i < venda.numParcelas; i++) {
                ...
                const valorParcela = isUltimaParcela 
                    ? valorBaseParcela + diferenca  // Última parcela ajusta os centavos
                    : valorBaseParcela;
                ...
                // Parcela 1: 1 mês após venda, Parcela 2: 2 meses após venda, etc
                const vencimento = new Date(dataVenda);
                
                // Adiciona (i+1) meses à data da venda
                ...
                // Verifica se mudou de mês (significa que o mês não tem 30 dias)
            ...
            localStorage.setItem('parcelas', JSON.stringify(parcelas));
            console.log('✅ Parcelas geradas e salvas! Valores iguais exceto última que ajusta centavos.');
        }
            ...
            vendas.forEach(v => {
                ...
                tbody.innerHTML += `
                    <tr>
                        ...
                        <td>${v.cliente || '-'}</td>
                        <td>${v.tipoPagamento === 'vista' ? 'À Vista' : v.numParcelas + 'x'}</td>
                        <td><span class="badge ${badgeClass}">${v.status}</span></td>
                        <td>
                            <button class="btn-delete" onclick="editarVenda(${v.id})" style="background: var(--accent); margin-right: 5px;">✏️ Editar</button>
                            <button class="btn-delete" onclick="deletarVenda(${v.id})">🗑️ Excluir</button>
                        </td>
                    </tr>
                `;
            });
        ...
        function deletarVenda(id) {
            if (confirm('Deseja realmente excluir esta venda? As parcelas relacionadas também serão excluídas.')) {
        ...
        function editarVenda(id) {
            ...
            alert('Venda carregada para edição. As parcelas antigas serão substituídas ao salvar.');
        }
        ...
        function renderizarParcelas() {
            ...
            parcelasOrdenadas.forEach(p => {
                ...
                // Calcular lucro se não existir (para parcelas antigas)
                if (!p.lucroParcela) {
                    const custoUnitMedio = compras.length > 0 
                        ? compras.reduce((acc, c) => acc + c.valorTotal, 0) / compras.reduce((acc, c) => acc + c.quantidade, 0)
                        : 0;
                ...
                tbody.innerHTML += `
                    <tr style="${isPago ? 'opacity: 0.7; background: rgba(6, 214, 160, 0.05);' : ''}">
                        ...
                        <td>
                            ${p.status === 'Pendente' ? 
                                `<button class="btn-delete" onclick="marcarComoPago(${p.id})" style="background: var(--success);">✓ Receber</button>` :
                                `<button class="btn-delete" onclick="marcarComoPendente(${p.id})" style="background: var(--accent);">↺ Reverter</button>`
                            }
                        </td>
                    </tr>
                `;
            ...
            // Calcular próximo vencimento e valor do próximo mês
            const hoje = new Date();
            ...
            if (parcelasPendentesOrdenadas.length > 0) {
                ...
                // Encontrar todas as parcelas do mesmo mês
            ...
            // Calcular lucro total a receber e já recebido
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                            <div>
                                ...
                                <div style="font-size: 12px; color: var(--gray); margin-top: 5px;">
                                    ${dados.parcelas.length} parcela(s) • ${dados.pagas} paga(s) • ${dados.pendentes} pendente(s)
                                </div>
                            </div>
        ...
        function marcarComoPago(id) {
            ...
            if (parcela) {
                ...
                // 🔥 ATUALIZAR NA CLOUD AUTOMATICAMENTE
                salvarParcelaNaCloud(parcela);
        ...
        function marcarComoPendente(id) {
            ...
            if (parcela) {
                if (confirm(`Deseja reverter o pagamento da parcela ${parcela.numeroParcela}/${parcela.totalParcelas}?`)) {
                    ...
                    console.log('↩️ Parcela revertida para pendente:', {
                        cliente: parcela.cliente,
                        parcela: `${parcela.numeroParcela}/${parcela.totalParcelas}`
                    });
                    ...
                    alert('↩️ Parcela revertida para PENDENTE!\n\n💰 Financeiro atualizado!');
                }
            }
        }
        ...
        function togglePagamento(id, isPago) {
            ...
            if (isPago) {
                ...
                console.log('✅ Parcela marcada como PAGA via checkbox:', {
                    cliente: parcela.cliente,
                    parcela: `${parcela.numeroParcela}/${parcela.totalParcelas}`,
                    valor: formatarMoeda(parcela.valor),
                    lucro: formatarMoeda(parcela.lucroParcela || 0)
                ...
                console.log('⏸️ Parcela desmarcada (pendente) via checkbox:', {
                    cliente: parcela.cliente,
                    parcela: `${parcela.numeroParcela}/${parcela.totalParcelas}`
                });
            }
            ...
            mostrarNotificacao(isPago ? 
                `✓ Parcela ${parcela.numeroParcela}/${parcela.totalParcelas} RECEBIDA! Valor: ${formatarMoeda(parcela.valor)}` : 
                `⏸️ Parcela ${parcela.numeroParcela}/${parcela.totalParcelas} marcada como PENDENTE`
            );
        }
        ...
        function salvarImpostos() {
            ...
            console.log('💰 Percentual de impostos atualizado:', percentualImpostos + '%');
            atualizarDashboard();
            mostrarNotificacao(`✓ Impostos configurados: ${percentualImpostos}%`);
        }
        ...
        function atualizarDashboard() {
            ...
            // CÁLCULO SIMPLES DO LUCRO:
            // Para cada venda, calcular o lucro real baseado no custo unitário específico
            let totalLucro = 0;
            let custoTotalVendas = 0;
            
            // Calcular custo médio unitário de cada compra
            ...
            document.getElementById('analiseCapitalEstoque').textContent = formatarMoeda(valorEstoque);
            ...
            document.getElementById('analiseEficiencia').textContent = percentRecebido.toFixed(1) + '%';
        ...
        // Formatar moeda COM centavos (quando necessário em casos específicos)
        ...
        function exportarDados() {
            ...
            // Método 1: Tentar download direto
            try {
                ...
                // Método 2: Copiar para área de transferência
                console.error('Download bloqueado, usando método alternativo:', error);
                ...
                navigator.clipboard.writeText(jsonString).then(() => {
                    ...
                    // Método 3: Mostrar em modal para copiar manualmente
                    mostrarDadosParaCopiar(jsonString);
                });
            }
        }

        // Mostrar dados em modal para cópia manual
        function mostrarDadosParaCopiar(jsonString) {
            ...
            content.innerHTML = `
                <h2 style="color: #333; margin-bottom: 20px;">📋 Copie os dados abaixo:</h2>
                <textarea 
                    id="dadosExport" 
            ...
            reader.onload = function(e) {
                try {
                    ...
                    if (confirm(`📥 Importar dados do backup?\n\n` +
                               ...
                               `✓ Compras: ${dados.compras?.length || 0}\n` +
                        ...
                        alert(`✅ Dados importados com sucesso!\n\n` +
                              ...
                              `✓ ${parcelas.length} parcelas carregadas\n\n` +
                              `Sistema atualizado!`);
                    }
                } catch (error) {
        ...
        function limparDados() {
            if (confirm('⚠️ ATENÇÃO! Isso irá apagar TODOS os dados (compras, vendas e parcelas).\n\nDeseja continuar?')) {
                if (confirm('Tem certeza? Esta ação não pode ser desfeita!')) {
                    ...
                    alert('✓ Dados limpos com sucesso! Uma compra de exemplo foi adicionada.');
        ...
        // ==========================================
        // FUNÇÕES CLOUD BACKUP
        // ==========================================

        async function fazerLoginCloud() {
            if (!supabaseClient) {
                alert('❌ Funcionalidade Cloud não disponível.\n\nVerifique sua conexão com a internet e recarregue a página.');
                return false;
            }
            ...
            try {
                mostrarNotificacao('🔄 Conectando à cloud...');
                ...
                if (error && error.message.includes('Invalid')) {
                    if (confirm('Conta não encontrada. Deseja criar uma nova conta?')) {
                        ...
                        mostrarNotificacao('✅ Conta criada! Fazendo login...');
                ...
                console.log('✅ Login cloud realizado:', usuarioCloud.email);
                mostrarNotificacao('✅ Conectado à cloud: ' + usuarioCloud.email);
                
                return true;
            } catch (error) {
                console.error('❌ Erro no login cloud:', error);
        ...
        async function fazerBackupCloud() {
            ...
            if (confirm('📤 Fazer backup de TODOS os dados para a cloud?\n\n' +
                       `Compras: ${compras.length}\n` +
                       `Vendas: ${vendas.length}\n` +
                       `Parcelas: ${parcelas.length}\n\n` +
                       'Isso irá SUBSTITUIR os dados na cloud.')) {
                
                try {
                    mostrarNotificacao('☁️ Enviando dados para cloud...');
                    
                    // Corrigir IDs decimais das parcelas (se houver)
                    console.log('🔧 Verificando e corrigindo IDs...');
                    parcelas.forEach(parcela => {
                        if (!Number.isInteger(parcela.id)) {
                            parcela.id = Math.floor(parcela.id);
                            console.log('  ✓ ID corrigido:', parcela.id);
                        }
                    });
                    localStorage.setItem('parcelas', JSON.stringify(parcelas));

                    // 1. Backup das Compras
                    console.log('📤 Enviando compras...');
                    ...
                    // 4. Backup das Configurações (Impostos e Inflação)
                    ...
                    mostrarNotificacao('✅ Backup realizado com sucesso na cloud!');
                    
                    alert(`✅ Backup concluído!\n\n` +
                          `✓ ${compras.length} compras\n` +
                          `✓ ${vendas.length} vendas\n` +
                          `✓ ${parcelas.length} parcelas\n\n` +
                          `Seus dados estão seguros na cloud! ☁️`);
        ...
        async function restaurarDaCloud() {
            ...
            if (confirm('📥 Restaurar dados da cloud?\n\n' +
                       '⚠️ ATENÇÃO: Isso irá SUBSTITUIR todos os dados locais pelos dados da cloud!\n\n' +
                       'Tem certeza?')) {
                
                try {
                    mostrarNotificacao('☁️ Baixando dados da cloud...');

                    // 1. Restaurar Compras
                    console.log('📥 Baixando compras...');
                    const { data: comprasCloud, error: comprasError } = await supabaseClient
                        .from('compras')
                        .select('*')
                        .eq('user_id', usuarioCloud.id);
                    ...
                    mostrarNotificacao('✅ Dados restaurados da cloud com sucesso!');
        ...
        async function verificarStatusCloud() {
            ...
            if (!usuarioCloud) {
                alert('ℹ️ Cloud Backup Disponível\n\n' +
                      'Você pode fazer backup dos seus dados na nuvem!\n\n' +
                      'Clique em "☁️ Backup para Cloud" para começar.');
                return;
            }

            try {
                mostrarNotificacao('🔍 Verificando cloud...');
                ...
                alert(`📊 Status Cloud Backup\n\n` +
                      `👤 Usuário: ${usuarioCloud.email}\n\n` +
                      `☁️ Na Cloud:\n` +
                      `• ${comprasCount || 0} compras\n` +
                      `• ${vendasCount || 0} vendas\n` +
                      `• ${parcelasCount || 0} parcelas\n\n` +
                      `💾 Local:\n` +
                      `• ${compras.length} compras\n` +
                      `• ${vendas.length} vendas\n` +
                      `• ${parcelas.length} parcelas`);
        ...
        // ==========================================
        // FIM DAS FUNÇÕES CLOUD
        // ==========================================

        // Carregar inflação salva e renderizar ao iniciar
        window.addEventListener('load', () => {
            console.log('🚀 Sistema de Gestão J16 Tracker Iniciado!');
            console.log('================================================');
            ...
            console.log('💡 Dica: Abra o Dashboard para ver o resumo financeiro completo');
        });
    </script>
</body>
</html>
